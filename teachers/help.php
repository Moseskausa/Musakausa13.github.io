    ...
    <div class="home-content">
      ...
      <div class="stat-boxes">
        <div class="recent-stat box" style="width:100%">
          ...
          <h4>Q5. How to conduct trainings ?</h4>
          <p>Ans: Navigate to the course tab by clicking on the course button from the left navigation bar. New tests can be added and old ones can also be deleted from here according to your preference. After adding a course, click on the edit icon to add questions.</p><br>
          <p><b>Important notice:</b> Once the course questions has been added once, do not try to update the questions. It can cause error in the functioning of the website. Updating the existing questions feature will be introduced in the future updates.</p>
           <div class="credits">
            <span class="text" style="text-align: center;">Made <❤️> <br>Contact me on: moses.kausa@gmail.com </span>
          </div>
        </div>
      </div>
    </div>
