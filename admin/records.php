    ...
    <div class="home-content">
      <div class="stat-boxes">
        ...
        <div class="top-stat box">
          <div class="title">Add new participant</div>
          <br><br>
          <img src="../img/anon.png" alt="pro" style=" display: block; margin-left: auto; margin-right: auto; width:30%; max-width:200px";>
            <form action="adduser.php" method="post">
              <label for="fname">First Name</label><br>
				      <input class="inputbox" type="text" id="fname" name="fname" placeholder="Enter fisrt name" minlength ="4" maxlength="30" required /></br>
			  <label for="lname">Last Name</label><br>
				      <input class="inputbox" type="text" id="lname" name="lname" placeholder="Enter last name" minlength ="4" maxlength="30" required /></br> 		  
              ...
              <br><br> 
			   ...
			   <label for="org">Organisation</label><br>
				      <input class="inputbox" type="text" id="org" name="org" placeholder="Enter Organisation" minlength ="1" maxlength="100" required /><br>    
              <br><br>                           
			  
             <label for="phone">Phone</label><br>
				      <input class="inputbox" type="text" id="phone" name="phone" placeholder="Enter phone (0975/0965)" minlength ="1" maxlength="10" required /><br>    
              <br><br>                             
